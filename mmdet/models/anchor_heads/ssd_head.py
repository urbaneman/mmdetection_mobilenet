...
class SSDHead(AnchorHead):
    ...
    def loss(self,
        ...
        # print("%s %s" % (len(featmap_sizes), len(self.anchor_generators)))
        assert len(featmap_sizes) == len(self.anchor_generators), print("error: %s %s"%(len(featmap_sizes), len(self.anchor_generators)))
